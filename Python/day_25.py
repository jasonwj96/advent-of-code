...
doesn't say what Error 2023 means, but it does have the phone number for a support line printed
on it.
...
the same configuration. Each connection between two components is represented only once,
...
"""
--- Part Two ---
You climb over weather machines, under giant springs, and narrowly avoid a pile of pipes as you 
find and disconnect the three wires.

A moment after you disconnect the last wire, the big red reset button module makes a small ding 
noise:

System overload resolved!
Power required is now 50 stars.
Out of the corner of your eye, you notice goggles and a loose-fitting hard hat peeking at you 
from behind an ultra crucible. You think you see a faint glow, but before you can investigate, 
you hear another small ding:
...
with open('input/input_25.txt') as f:
    for line in f:

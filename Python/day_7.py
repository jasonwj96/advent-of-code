...
(At least it's a cool airship!) It drops you off at the edge of a vast desert and descends back to
Island Island.
...
considering the second card in each hand. If they differ, the hand with the higher second card wins;
...
card is stronger. Similarly, 77888 and 77788 are both a full house, but 77888 is stronger because
...
To balance this, J cards are now the weakest individu
al cards, weaker even than 2. 
...
type; for example, QJJQ2 is now considered four of a kind. 
